...
// <View className="mt-6 rounded-2xl bg-light-200 shadow-sm">
//             <Text className="mb-4 font-montserrat text-lg text-dark-900">Watch History</Text>
//             <View>
//               {history ? (
//                 history.map((item: any, index: any) => (
//                   <View key={index} className="mb-5 flex-row items-start">
//                     {/* The timeline graphic part (line and circle) */}
//                     <View className="mr-4 items-center">
//                       <View className="h-8 w-8 items-center justify-center rounded-full bg-dark-300">
//                         <MaterialCommunityIcons name="calendar-clock" size={12} color="#D28D2D" />
//                       </View>
//                       {index < history.length - 1 && <View className="w-0.5 flex-1 bg-dark-100" />}
//                     </View>
//                     {/* The text content part */}
//                     <View className="flex-1 ">
//                       <Text className="text-base font-bold text-gray-700">
//                         {formatDate(item.watched_at, 'MMMM d, yyyy')}
//                       </Text>
//                       <Text className="text-sm text-gray-500">
...
//             </View>
//           </View>
//           <View className="mb-4 mt-6 rounded-2xl bg-light-200 shadow-sm">
//             <Text className="mb-4 font-montserrat text-lg text-dark-900">Watch History</Text>
...
//                   <View
//                     key={index}
//                     className="m-1 flex-row items-center rounded-full border border-dark-900 bg-light-300 px-3 py-1.5">
//                     <Feather name="tv" size={12} color="#D28D2D" />
//                     <Text className="ml-1.5 text-xs font-semibold text-dark-600">
//                       {formatDate(item.watched_at, 'MMMM d, yyyy')}
//                     </Text>
//                   </View>
//                 ))
